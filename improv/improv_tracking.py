...
from stytra.gui.camera_display import CameraViewFish, EyeTrackingSelection, TailTrackingSelection, EyeTailTrackingSelection, SingleLineROI
...
class TimeUpdater(Stimulus):
    ...
    def update(self):
        ...
        try:
            ...
            self.exp_elapsed = self.sent_times
        ...
        data = [self._experiment.estimator.get_velocity()]
...
class ExternalCameraDisplay(CameraViewFish):
    ...
    def retrieve_image(self):
        ...
        try:
            ...
            if n_points_tail:
                tail_len = (
                    self.tracking_params.tail_length[1] / self.tracking_params.n_segments
                )
...
class ExternalTrackingExperimentWindow(TrackingExperimentWindow):
    def __init__(self, *args, **kwargs):
        ...
        super().__init__(*args, **kwargs)
        self.camera_display = ExternalCameraDisplay_embed(experiment=kwargs["experiment"])
...
class ExternalTrackingExperiment(TrackingExperiment):
    ...
    def make_window(self):
        ...
        #self.window_main2 = ExternalTrackingExperimentWindow(experiment=self)
        self.window_main.construct_ui()
        #self.window_main2.construct_ui()
        self.initialize_plots()
        self.window_main.show()
        #self.window_main2.show()
