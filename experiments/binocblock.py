...
stimulus_path = Path(sys.executable).parents[0].joinpath(r'Lib\site-packages\pandastim\resources\protocols\binocblock.hdf')
...
def wrapper(protocol, stimulus_dataframe_path, ports, params, parameter_path):
    ...
    pstim = stimulus.BehaviorStimulus(buddy=stytraBuddy, params_path=parameter_path, rad_stack = rad_stack)
